 ...
 *     7  |  0x005c  |  31: 0  |  0xffffffff  ||  HWPE_COEFF0_V
 *     8  |  0x0060  |  31: 0  |  0xffffffff  ||  HWPE_COEFF1_V
 *     9  |  0x0064  |  31: 0  |  0xffffffff  ||  HWPE_COEFF2_V
 *     10  |  0x0068  |  31: 0  |  0xffffffff  ||  HWPE_COEFF3_V
 * ================================================================================
 *
 */
/* LOW-LEVEL HAL */
...
// custom hal
static inline void hwpe_coeff0_v_set(uint32_t value) {
  HWPE_WRITE(value, HWPE_COEFF0_V );
}
static inline void hwpe_coeff1_v_set(uint32_t value) {
  HWPE_WRITE(value, HWPE_COEFF1_V );
}
static inline void hwpe_coeff2_v_set(uint32_t value) {
  HWPE_WRITE(value, HWPE_COEFF2_V );
}
static inline void hwpe_coeff3_v_set(uint32_t value) {
  HWPE_WRITE(value, HWPE_COEFF3_V );
}
