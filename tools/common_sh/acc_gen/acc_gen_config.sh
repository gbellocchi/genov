...
fetch_ov_config()
{
    echo -e ""
    echo "# ======================================= #"
    echo "# Fetching accelerator-rich configuration #"
    echo "# ======================================= #"
    echo -e ""
...
optimize_ov_specs()
{
    echo -e ""
    echo "# ================================================ #"
    echo "# Optimizing system-level accelerators information #"
    echo "# ================================================ #"
    echo -e ""
    ...
    do  
        ...
        make --silent ov_gen_opt TARGET_ACC=${acc_targets[$c]} OFFSET_ACC=$c
    done
}
