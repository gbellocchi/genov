...
(* CORE_GENERATION_INFO="MUL,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xczu9eg-ffvb1156-2-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=pipeline,HLS_SYN_CLOCK=3.420000,HLS_SYN_LAT=1,HLS_SYN_TPT=1,HLS_SYN_MEM=0,HLS_SYN_DSP=4,HLS_SYN_FF=2,HLS_SYN_LUT=55,HLS_VERSION=2019_2}" *)
...
wire  signed [31:0] ret_V_fu_57_p0;
wire  signed [31:0] ret_V_fu_57_p1;
reg   [0:0] ap_NS_fsm;
...
assign ret_V_fu_57_p0 = x2_V_TDATA_int;

assign ret_V_fu_57_p1 = x1_V_TDATA_int;

assign y_V_TDATA_int = ($signed(ret_V_fu_57_p0) * $signed(ret_V_fu_57_p1));
