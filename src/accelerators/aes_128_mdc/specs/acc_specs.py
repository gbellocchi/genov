...
class acc_specs:
    ...
    def streaming(self):
        self.list_sink_stream                   = [ [ 'text' , 'int32_t' , 32 , False, 1 ] , [ 'key' , 'int32_t' , 32 , False, 1 ] , [ 'rc' , 'int32_t' , 32 , False, 1 ] ]
        self.list_source_stream                 = [ [ 'chiped_text' , 'int32_t' , 32 , False, 1 ] ]
        return self
