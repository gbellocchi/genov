...
// ==============================================================
#ifndef __fir_128_mdc_mul_5bkb__HH__
#define __fir_128_mdc_mul_5bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(fir_128_mdc_mul_5bkb) {
    ...
    SC_CTOR(fir_128_mdc_mul_5bkb):  ACMP_mul_us_U ("ACMP_mul_us_U") {
