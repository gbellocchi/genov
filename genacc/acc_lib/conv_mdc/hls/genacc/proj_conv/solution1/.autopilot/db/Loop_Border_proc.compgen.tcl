...
set ID 25
set hasByteEnable 0
set MemName Loop_Border_proc_lbW
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { dst_V_TDATA { O 32 vector } dst_V_TVALID { O 1 bit } dst_V_TREADY { I 1 bit } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'dst_V'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_vconv_V \
    op interface \
    ports { vconv_V_dout { I 32 vector } vconv_V_empty_n { I 1 bit } vconv_V_read { O 1 bit } } \
} "
}
