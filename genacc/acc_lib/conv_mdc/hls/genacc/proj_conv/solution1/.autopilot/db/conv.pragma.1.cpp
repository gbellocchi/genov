...
_ssdm_InlineSelf(0, "");
 ...
 ((height < 1080) ? static_cast<void> (0) : __assert_fail ("height < 1080", "conv.cpp", 133, __PRETTY_FUNCTION__));
    ((width < 1920) ? static_cast<void> (0) : __assert_fail ("width < 1920", "conv.cpp", 134, __PRETTY_FUNCTION__));
    ((vconv_xlim < 1920 - (K - 1)) ? static_cast<void> (0) : __assert_fail ("vconv_xlim < 1920 - (K - 1)", "conv.cpp", 135, __PRETTY_FUNCTION__));
...
{
_ssdm_op_SpecInterface(src, "m_axi", 0, 0, "", 0, 32400, "", "", "", 16, 16, 16, 16, "", "");
_ssdm_op_SpecInterface(dst, "m_axi", 0, 0, "", 0, 32400, "", "", "", 16, 16, 16, 16, "", "");
_ssdm_op_SpecInterface(width, "s_axilite", 0, 0, "", 0, 0, "hls_ctrl", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(height, "s_axilite", 0, 0, "", 0, 0, "hls_ctrl", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(0, "s_axilite", 0, 0, "", 0, 0, "hls_ctrl", "", "", 0, 0, 0, 0, "", "");
...
{
_ssdm_op_SpecInterface(&src, "axis", 1, 1, "both", 0, 0, "", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(&dst, "axis", 1, 1, "both", 0, 0, "", "", "", 0, 0, 0, 0, "", "");
