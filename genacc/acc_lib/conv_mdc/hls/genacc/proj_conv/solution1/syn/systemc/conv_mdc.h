...
#ifndef _conv_mdc_HH_
#define _conv_mdc_HH_

#include "systemc.h"
#include "AESL_pkg.h"

#include "conv_mdc_entry7.h"
...
#include "start_for_Block_pmb6.h"
#include "start_for_Loop_Boncg.h"
#include "start_for_Loop_VCocq.h"

namespace ap_rtl {

struct conv_mdc : public sc_module {
    ...
    // Module declarations
    conv_mdc(sc_module_name name);
    SC_HAS_PROCESS(conv_mdc);
    ...
    sc_signal< sc_logic > conv_mdc_entry7_U0_ap_start;
    sc_signal< sc_logic > conv_mdc_entry7_U0_ap_done;
    sc_signal< sc_logic > conv_mdc_entry7_U0_ap_continue;
    sc_signal< sc_logic > conv_mdc_entry7_U0_ap_idle;
    sc_signal< sc_logic > conv_mdc_entry7_U0_ap_ready;
    sc_signal< sc_logic > conv_mdc_entry7_U0_start_out;
    sc_signal< sc_logic > conv_mdc_entry7_U0_start_write;
    sc_signal< sc_lv<32> > conv_mdc_entry7_U0_width_out_din;
    sc_signal< sc_logic > conv_mdc_entry7_U0_width_out_write;
    sc_signal< sc_lv<32> > conv_mdc_entry7_U0_width_out1_din;
    sc_signal< sc_logic > conv_mdc_entry7_U0_width_out1_write;
    sc_signal< sc_lv<32> > conv_mdc_entry7_U0_height_out_din;
    sc_signal< sc_logic > conv_mdc_entry7_U0_height_out_write;
    sc_signal< sc_lv<32> > conv_mdc_entry7_U0_height_out2_din;
    sc_signal< sc_logic > conv_mdc_entry7_U0_height_out2_write;
    ...
    sc_signal< sc_logic > width_c163_full_n;
    sc_signal< sc_lv<32> > width_c163_dout;
    sc_signal< sc_logic > width_c163_empty_n;
    sc_signal< sc_logic > height_c_full_n;
    sc_signal< sc_lv<32> > height_c_dout;
    sc_signal< sc_logic > height_c_empty_n;
    sc_signal< sc_logic > height_c164_full_n;
    sc_signal< sc_lv<32> > height_c164_dout;
    sc_signal< sc_logic > height_c164_empty_n;
    sc_signal< sc_logic > width_c165_full_n;
    sc_signal< sc_lv<32> > width_c165_dout;
    sc_signal< sc_logic > width_c165_empty_n;
    sc_signal< sc_logic > height_c166_full_n;
    sc_signal< sc_lv<32> > height_c166_dout;
    sc_signal< sc_logic > height_c166_empty_n;
    ...
    sc_signal< sc_logic > height_c167_full_n;
    sc_signal< sc_lv<32> > height_c167_dout;
    sc_signal< sc_logic > height_c167_empty_n;
    sc_signal< sc_logic > vconv_xlim_loc_c168_full_n;
    sc_signal< sc_lv<32> > vconv_xlim_loc_c168_dout;
    sc_signal< sc_logic > vconv_xlim_loc_c168_empty_n;
    ...
    void thread_conv_mdc_entry7_U0_ap_continue();
    void thread_conv_mdc_entry7_U0_ap_start();
